...
class OnboardingViewController: UIViewController {
    ...
    init(pages: [OnboardingPartViewController] = [OnboardingPartViewController](),
...
private extension OnboardingViewController {
    ...
    func setupButton() {
        ...
        bottomButton.addTarget(self, action: #selector(buttomPressed), for: .touchUpInside)
